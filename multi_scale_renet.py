...
class MSResNet(nn.Module):
    def __init__(self, input_channel, n_output=49):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
        ...
        self.block5x5 = nn.Sequential(
            ...
            nn.BatchNorm1d(256),
            nn.ReLU(inplace=True),
            nn.Conv1d(256, 256, kernel_size=5, stride=1, padding=2, bias=False),
            nn.BatchNorm1d(256),
            nn.ReLU(inplace=True),
        )
        # maxplooing kernel size: 16, 11, 6
        ...
        self.fc = nn.Linear(256*3, n_output)
    ...
    def _make_layer5(self, block, planes, blocks, stride=1):
        downsample = None
    ...
    def _make_layer7(self, block, planes, blocks, stride=1):
        downsample = None
